...
<head>
    ...
    <title>VGA F1 Billings - Add New F1 f1.DriverV0</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        <label for="driverName">f1.DriverV0 Name</label>
                        <a href="#" class="tooltipDemo" data-toggle="tooltip" title="F1 f1.DriverV0 Name."></a>
                        <input class="form-control required_input" type="text" name="driverName" id="driverName" value="${newDriver?.name}">
                    </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        <label for="team">Team f1.DriverV0</label>
                        <a href="#" class="tooltipDemo" data-toggle="tooltip" title="Type: Purchase/Refund"></a>
